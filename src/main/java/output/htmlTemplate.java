...
import actions.ReportStatisticAction;
...
//        file.mkdir();
//        String text = getStr(ReportStatisticAction.getNames(), ReportStatisticAction.getValues(), ReportStatisticAction.getJavadoc());
